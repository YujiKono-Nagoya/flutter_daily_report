                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          Expanded(
                              flex: 2,
                              child: MyText3(controller: rampStep, unit: '基')),
                          SizedBox(width: 3),
                          Expanded(
                              child: MyText3(controller: rampplace, unit: 'ヶ所'))
                        ],
                      ),
                      SizedBox(height: 20),
                      Row(
                        children: [
                          ...
                          SizedBox(width: 3),
                          Expanded(
                              child: MyText3(controller: square, unit: 'm²'))
                        ],
                      ),
                      SizedBox(height: 5),
                      Row(
                      ...
                      Row(
                        children: [
                          ...
                          Expanded(
                              flex: 1,
                              child: MyText4(controller: spanEast, unit: '東')),
                        ],
                      ),
                      SizedBox(height: 5),
                      Row(
                        children: [
                          ...
                          Expanded(
                              flex: 2,
                              child: MyText4(controller: spanWest, unit: '西')),
                        ],
                      ),
                      SizedBox(height: 5),
                      Row(
                        children: [
                          ...
                          Expanded(
                              flex: 2,
                              child: MyText4(controller: spanSouth, unit: '南')),
                        ],
                      ),
                      SizedBox(height: 5),
                      Row(
                        children: [
                          ...
                          Expanded(
                              flex: 2,
                              child: MyText4(controller: spanNouth, unit: '北')),
                        ],
                      ),
                      SizedBox(height: 20),
                      Row(
                        children: [
                          ...
                          Expanded(
                              flex: 1,
                              child:
                                  MyText4(controller: heightEast, unit: '東')),
                          SizedBox(width: 3),
                          Expanded(
                              flex: 1,
                              child:
                                  MyText4(controller: heightWest, unit: '西')),
                        ],
                      ),
                      SizedBox(height: 5),
                      Row(
                        children: [
                          ...
                          Expanded(
                              flex: 2,
                              child:
                                  MyText4(controller: heightSouth, unit: '南')),
                          SizedBox(width: 3),
                          Expanded(
                              flex: 2,
                              child:
                                  MyText4(controller: heightNouth, unit: '北'))
                        ],
                      ),
                      SizedBox(height: 20),
                      Row(
                        children: [
                          ...
                          Expanded(
                              flex: 1,
                              child:
                                  MyText3(controller: rollingStep, unit: '基')),
                          SizedBox(width: 3),
                          Text('H=',
                              style: TextStyle(
                          ...
                          Expanded(
                              flex: 1,
                              child:
                                  MyText3(controller: rollingHeight, unit: '')),
                        ],
                      ),
                      SizedBox(height: 5),
                      Row(
                        children: [
                          ...
                          Expanded(
                              flex: 2,
                              child:
                                  MyText3(controller: rollingWidth, unit: '')),
                          SizedBox(width: 3),
                          Text('×',
                              style: TextStyle(
                    ...
                    children: [
                      Row(
                        children: [
                          Expanded(
                              flex: 1,
                              child: MyText3(controller: startTime, unit: '')),
                          Expanded(
                              flex: 1,
                              child: MyText3(controller: closingTime, unit: ''))
                        ],
                      ),
                      SizedBox(height: 3),
                      MyText3(
